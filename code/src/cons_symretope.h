...
/**@file   cons_symretope.h
 * @ingroup CONSHDLRS
 * @brief  constraint handler for symretope constraints
...
#ifndef __SCIP_CONS_SYMRETOPE_H__
#define __SCIP_CONS_SYMRETOPE_H__
...
/** creates the handler for symretope constraints and includes it in SCIP
 *
 ...
 *
 *  @see SCIPcreateConsSymretope() for the default constraint flag configuration
 *
 *  @note the constraint gets captured, hence at one point you have to release it using the method SCIPreleaseCons()
 */
SCIP_EXPORT
