...
/** variant of relabeling for symretopes */
enum SCIP_SymretopeRelabel
{
   SCIP_RELABEL_NONE                = 0,     /**< No relabeling should be applied. */
   SCIP_RELABEL_DECREASINGCYCLESIZE = 1,     /**< Sort subcycles by decreasing subcycle size (largest subcycle first) */
   SCIP_RELABEL_INCREASINGCYCLESIZE = 2,     /**< Sort subcycles by increasing subcycle size (smallest first) */
   SCIP_RELABEL_INCREASINGSUBCYCLEMININDEX = 3, /**< Sort subcycles by smallest original index in the subcycles */
};
typedef enum SCIP_SymretopeRelabel SCIP_SYMRETOPERELABEL;
